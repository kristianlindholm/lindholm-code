...
> **For React-specific review, prefer `react-reviewer`.** This block remains as a fallback only — when the diff contains `.tsx`/`.jsx` files, both agents should be invoked.
