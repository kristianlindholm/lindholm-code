...
> This file extends the Global `patterns.md` rule with Dart, Flutter, and common ecosystem-specific content.
...
See skill: dart-flutter-patterns for Flutter and Dart patterns.
