...
> This file extends the Global `patterns.md` rule with Kotlin and Android/KMP-specific content.
...
See skill: kotlin-patterns for coroutines and idiomatic Kotlin.
